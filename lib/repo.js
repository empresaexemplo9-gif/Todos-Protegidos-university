...
/* ------------------------------ catálogo ------------------------------ */
const CATALOG_SEED_VERSION = `2026-08-21-imagens-reais-${catalogImagesVersion}`;
  ...
  for (const item of initialCatalog) {
    ...
    await sql`
      ...
      ON CONFLICT (id) DO UPDATE SET
        ...
        END,
        updated_at = CASE
          WHEN sona_catalog_items.image_url = '' AND EXCLUDED.image_url <> '' THEN EXCLUDED.updated_at
