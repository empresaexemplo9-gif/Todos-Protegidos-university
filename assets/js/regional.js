...
(function () {
  ...
  // ---- Motor de gráficos ----
  // Vive em assets/js/graficos.js, compartilhado com o Financeiro.
  var G = window.TPGraficos;
  var barras = G.barras, linhas = G.linhas;
  ...
  // Vive em assets/js/planilha.js, compartilhado com o Financeiro.
  var analisarLink = window.TPLinkPlanilha;
